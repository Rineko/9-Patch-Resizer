 ...
 * @version 1.0.1
 */
public class FileDrop<T extends Component> {
     ...
     * @since 1.0
     */
    public FileDrop(final T c, final Listener<T> listener) {
     ...
     * @since 1.0
     */
    public FileDrop(final T c, final boolean recursive,
     ...
     * @since 1.0
     */
    public FileDrop(final java.io.PrintStream out, final T c,
                    final Listener<T> listener) {
     ...
     */
    public FileDrop(final java.io.PrintStream out, final T c,
                    final boolean recursive, final Listener<T> listener) {
        this(out, // Logging stream
                c, // Drop target
                javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2,
                        defaultBorderColor), // Drag border
     ...
     * @since 1.0
     */
    public FileDrop(final T c, final javax.swing.border.Border dragBorder,
                    final Listener<T> listener) {
        this(null, // Logging stream
                c, // Drop target
        ...
        if (supportsDnD()) { // Make a drop listener
            this.dropListener = new java.awt.dnd.DropTargetListener() {
                ...
                public void dragOver(java.awt.dnd.DropTargetDragEvent evt) {
                    // This is called continually as long as
                    // the mouse is over the drag target.
                } // end dragOver
                ...
                public void dropActionChanged(
                    ...
                    // Is this an acceptable drag event?
                    if (FileDrop.this.isDragOk(out, evt)) { // evt.acceptDrag(
                        // java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE
                        // );
                        evt.acceptDrag(java.awt.dnd.DnDConstants.ACTION_COPY);
                        log(out, "FileDrop: event accepted.");
     ...
     * @since 1.1
     */
    public static interface Listener<T extends Component> {
         ...
         * @since 1.0
         */
        public abstract void filesDropped(T source, java.io.File[] files);

        public abstract void dragEnter(T source);

        public abstract void dragExit(T source);
    ...
    public static class Event extends java.util.EventObject {
        ...
        private static final long serialVersionUID = 6145536635297645995L;
